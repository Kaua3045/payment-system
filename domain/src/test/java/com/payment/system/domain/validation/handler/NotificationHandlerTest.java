package com.payment.system.domain.validation.handler;
...
import com.payment.system.domain.validation.Validator;
...
class NotificationHandlerTest extends UnitTest {
    ...
    void givenAValidValidation_whenCallValidate_thenShouldThrowsException() {
        final var expectedErrorMessage = "Cannot invoke \"com.payment.system.domain.validation.ValidationHandler$Validation.validate()\" because \"aValidation\" is null";
        NotificationHandler handler = NotificationHandler.create();
